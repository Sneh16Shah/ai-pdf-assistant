    ...
    <div className="w-full max-w-4xl mx-auto p-6">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-white">PDF Summary</h2>
          <button
        ...
        {summary && (
          <div className="space-y-6">
            ...
            {summary.key_takeaways && summary.key_takeaways.length > 0 && (
              <div>
                <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-300 mb-2">Key Takeaways</h3>
                <ul className="list-disc list-inside space-y-2 bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
            ...
            {summary.main_topics && summary.main_topics.length > 0 && (
              <div>
                <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-300 mb-2">Main Topics</h3>
