...
export default function ExplanationPanel({
    ...
    return (
        <div className="flex flex-col h-full bg-white dark:bg-gray-800 md:border-l dark:border-gray-700 shadow-lg">
            {/* Header */}
            <div className="flex items-center justify-between px-3 md:px-4 py-2 md:py-3 border-b dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
                ...
                <div className="flex items-center space-x-2">
                    <span className="text-xs text-gray-500 dark:text-gray-400 hidden md:inline">Ctrl+L to toggle</span>
                    <button
                        onClick={onClose}
